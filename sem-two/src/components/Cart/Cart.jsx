            ...
            >
              <CardBody>
                <div className={"cardImageDiv"}>
                  <ProductImage src={Images} className={"cardImage"} />
                </div>
              </CardBody>
              <CardBody>
                <h1>Rs.675</h1>
                ...
                <Row>
                  <Col lg={12}>
                    <p className={"cartFontText"}>
                      ...
                      plantersand make the environment go green and fresh. Both
                      the planters are in whitish color with option of
                      personalized name on one of them to make it look special.
                      The other planter has a beautiful New Year wishes on it. (
                      Only Planter Set).{" "}
                    </p>
                    <br />
                    <p className={"cartFontText"}>
