                    ...
                    <Col lg={8}>
                        <Container fulid={true}>
                            <Row>
                                <Col lg={12}>
                                    <Card >
                                        <CardBody style={{ backgroundColor: 'rgba(196, 196, 196, 0.5);',textAlign:'center',padding:'8%' ,height:'500px'}}>
                                            <Avatar aria-label="recipe" style={{marginLeft:'45%',width:'60px',height:'60px'}} >
